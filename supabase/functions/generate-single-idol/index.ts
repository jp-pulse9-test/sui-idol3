...
serve(async (req) => {
  ...
  try {
    ...
    // 이미지 프롬프트 생성
    const imagePrompt = `Professional K-pop idol portrait: ${finalPersonality} personality, ${finalConcept} concept, beautiful Korean idol, perfect makeup, stylish outfit, studio lighting, photorealistic, high quality`
