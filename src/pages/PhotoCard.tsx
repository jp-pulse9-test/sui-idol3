  ...
  useEffect(() => {
    ...
    try {
      ...
      const getPersonalityAnalysis = (personality: string, mbtiType: string | null) => {
        const analyses = {
          "카리스마틱": {
            default: "⚡ 당신은 강렬한 카리스마와 리더십에 끌리는 사람입니다.\n무대 위의 확신에 찬 모습에서 안정감을 느끼며,\n함께 성장할 수 있는 든든한 파트너를 원해요.",
            ENTJ: "👑 같은 리더형으로서 강한 카리스마와 목표 지향적인 성향에 공감하며,\n서로를 인정하고 함께 발전해나갈 수 있는 완벽한 파워 커플을 꿈꾸고,\n야망과 비전을 공유하며 서로를 지지해주는 관계를 원합니다.",
            ESTJ: "🏆 체계적이고 결단력 있는 성향이 일치하여,\n서로의 리더십을 존중하고 신뢰할 수 있는 든든한 관계를 원하며,\n계획적이고 책임감 있는 성격이 완벽하게 조화를 이룰 것 같아요."
          },
          "밝고 긍정적": {
            default: "☀️ 당신은 밝고 긍정적인 에너지를 추구하는 사람입니다.\n함께 있으면 세상이 더 밝아지는 느낌을 주는 관계를 꿈꾸며,\n순수하고 진심 어린 웃음이 마음을 따뜻하게 만들어줘요.",
            ESFP: "🎪 같은 외향형으로서 활발한 에너지와 소통을 중시하는 성향이 일치하여,\n함께 즐거운 순간들을 만들어갈 완벽한 파트너를 원하며,\n즉흥적이고 자유로운 성격으로 끝없는 모험을 함께 나누고 싶어해요.",
            ENFP: "🌟 무한한 가능성과 긍정적 에너지에 공감하며,\n서로의 열정을 이해하고 응원해줄 수 있는 영혼의 동반자를 찾고,\n창의적이고 열정적인 성격으로 새로운 꿈을 함께 키워가고 싶어해요."
          },
          "신비로운": {
            default: "🌙 당신은 깊이 있고 신비로운 매력에 끌리는 사람입니다.\n표면적인 것보다는 내면의 깊은 세계를 공유할 수 있는 특별한 관계를 원하며,\n신비롭고 독특한 매력이 호기심을 자극하고 평범함을 거부해요.",
            INFJ: "🔮 같은 직관형으로서 신비롭고 깊이 있는 성향에 공감하며,\n서로의 숨겨진 면을 이해하고 공유할 수 있는 운명적 만남을 찾고,\n이상주의적이고 직관적인 성격으로 깊은 정신적 교감을 나누고 싶어해요.",
            INFP: "🎭 내면의 예술적 감성과 이상주의적 성향이 반영되어,\n창조적 에너지를 가진 상대방에게서 자신의 숨겨진 모습을 발견하고 싶어하며,\n감성적이고 개성적인 성격으로 예술적 영감을 주고받고 싶어해요."
          },
          "에너지틱": {
            default: "🔥 당신은 끝없는 열정과 활력에 끌리는 사람입니다.\n함께 있으면 무엇이든 할 수 있을 것 같은 역동적인 관계를 원하며,\n에너지 넘치는 모습이 끊임없는 자극과 활력을 주어요.",
            ESTP: "🎯 같은 활동적인 성향으로서 즉흥적이고 에너지 넘치는 모습에 끌리며,\n함께 모험을 즐기고 활발한 삶을 살아갈 완벽한 동반자를 찾고,\n현실적이고 실용적인 성격으로 스릴 넘치는 경험들을 공유하고 싶어해요.",
            ESFP: "🎉 밝고 활발한 에너지가 일치하여,\n함께 즐거운 순간들을 만들고 활기찬 관계를 이어갈 파트너를 원하며,\n사교적이고 즉흥적인 성격으로 매일을 축제처럼 보내고 싶어해요."
          },
          "사랑스러운": {
            default: "💕 당신은 순수하고 사랑스러운 매력에 끌리는 사람입니다.\n서로를 소중히 여기고 보호해주고 싶은 달콤한 관계를 꿈꾸며,\n천진난만하고 애교 넘치는 모습이 모성/부성본능을 깨워줘요.",
            ISFP: "🌸 섬세하고 따뜻한 성향이 반영되어,\n상대방의 순수한 매력을 통해 자신의 온화한 면을 표현하고 싶어하며,\n감성적이고 배려심 깊은 성격으로 아늑하고 따뜻한 세계를 만들어가고 싶어해요."
          },
          "우아한": {
            default: "✨ 당신은 세련되고 우아한 매력에 끌리는 사람입니다.\n서로의 품위를 인정하고 존중하는 고급스러운 관계를 추구하며,\n우아하고 지적인 매력이 미적 감각을 자극하고 취향의 일치를 중요하게 여겨요.",
            ISFJ: "🤍 배려심 깊고 품격 있는 성향이 일치하여,\n서로를 아끼고 존중하는 클래식하고 우아한 관계를 원하며,\n온화하고 신중한 성격으로 서로의 품위를 높여주는 조화로운 관계를 꿈꿔요."
          },
          "상큼한": {
            default: "🌸 당신은 밝고 발랄한 에너지에 끌리는 사람입니다.\n함께 있으면 젊어지는 느낌과 새로운 활력을 얻는 관계를 원하며,\n청춘 넘치고 생기발랄한 매력이 즐거움과 풋풋한 설렘을 줘요.",
            ENFP: "🌺 같은 활발한 성향으로서 상큼하고 긍정적인 에너지에 공감하며,\n서로를 밝게 만들어줄 수 있는 완벽한 파트너를 찾고,\n자유롭고 창의적인 성격으로 매일 새로운 모험과 즐거움을 발견하고 싶어해요."
          }
        };
