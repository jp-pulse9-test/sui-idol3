...
const translations = {
  ko: {
    ...
    'enterDialog.title': '2028 구원 작전 시작',
    'enterDialog.subtitle': '지구 멸망을 막기 위한 여정을 시작합니다',
    'enterDialog.quickStart.title': '디폴트 캐릭터로 빠른 시작',
    'enterDialog.quickStart.description': '미션을 바로 시작합니다',
    'enterDialog.selectIdol.title': '내 AIDOL 직접 선택하기',
    'enterDialog.selectIdol.description': '토너먼트를 통해 이상형 찾기',
  ...
  en: {
    ...
    'enterDialog.title': 'Begin 2028 Salvation Operation',
    'enterDialog.subtitle': 'Start your journey to prevent Earth\'s destruction',
    'enterDialog.quickStart.title': 'Quick Start with Default Character',
    'enterDialog.quickStart.description': 'Begin missions immediately',
    'enterDialog.selectIdol.title': 'Select My AIDOL',
    'enterDialog.selectIdol.description': 'Find your ideal through tournament',
