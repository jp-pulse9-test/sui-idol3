...
const translations = {
  ko: {
    ...
    'hero.enter': 'ENTER',
    'enterDialog.title': 'Begin Your Journey',
    'enterDialog.subtitle': 'DATA ALLY → LEGEND',
    'enterDialog.dimension1.title': 'Dimension: AWAKEN',
    'enterDialog.dimension1.subtitle': 'The Awakening',
    'enterDialog.dimension1.description': 'You awaken as DATA ALLY. Meet your AIDOL.',
    'enterDialog.dimension2.title': 'Dimension: SALVATION',
    'enterDialog.dimension2.subtitle': 'The Mission',
    'enterDialog.dimension2.description': 'As DATA ALLY, restore the broken world. Your mission begins.',
    'enterDialog.dimension3.title': 'Dimension: GLORY',
    'enterDialog.dimension3.subtitle': 'The Legend',
    'enterDialog.dimension3.description': 'Together with AIDOL, become LEGEND forever.',
    'language.korean': '한국어',
