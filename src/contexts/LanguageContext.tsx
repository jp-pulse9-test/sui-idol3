...
const translations = {
  ko: {
    ...
    'enterDialog.subtitle': '2028 붕괴를 막는 여정이 시작됩니다',
    'enterDialog.dimension1.title': 'Quick Start',
    'enterDialog.dimension1.subtitle': '빠른 시작',
    'enterDialog.dimension1.description': '바로 미션 시작',
    'enterDialog.dimension2.title': 'Select AIDOL',
    'enterDialog.dimension2.subtitle': 'AIDOL 선택',
    'enterDialog.dimension2.description': 'AIDOL을 직접 선택하고 시작',
    'enterDialog.dimension3.title': 'Tournament Mode',
    'enterDialog.dimension3.subtitle': '토너먼트',
    'enterDialog.dimension3.description': '16강 토너먼트로 최고의 AIDOL 찾기',
    'language.korean': '한국어',
  ...
  en: {
    ...
    'enterDialog.dimension1.title': 'Quick Start',
    'enterDialog.dimension1.subtitle': 'Quick Start',
    'enterDialog.dimension1.description': 'Start Mission',
    'enterDialog.dimension2.title': 'Select AIDOL',
    'enterDialog.dimension2.subtitle': 'Select AIDOL',
    'enterDialog.dimension2.description': 'Choose your AIDOL and begin',
    'enterDialog.dimension3.title': 'Tournament Mode',
    'enterDialog.dimension3.subtitle': 'Tournament Mode',
    'enterDialog.dimension3.description': 'Find your best AIDOL through 16-match tournament',
    'language.korean': '한국어',
    'language.english': 'English',
    'journey.title': 'Begin Your Journey',
